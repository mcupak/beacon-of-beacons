...
import static com.dnastack.bob.service.parser.util.ParseUtils.parseIntegerFromJson;
...
public class JsonIntegerPresentResponseParser implements ResponseParser, Serializable {
    ...
    public synchronized Future<Boolean> parse(Beacon b, Future<String> response) {
        Boolean res = null;
        try {
            Integer variantId = parseIntegerFromJson(response.get(REQUEST_TIMEOUT, TimeUnit.SECONDS), "variantid");
            res = variantId != null;
