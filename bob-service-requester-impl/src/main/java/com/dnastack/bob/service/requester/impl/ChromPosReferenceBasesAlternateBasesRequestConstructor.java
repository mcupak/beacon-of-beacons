...
/**
 * Request constructor using URL with chrom, pos, reference bases and alternate bases.
 *
 * @author Miroslav Cupak (mirocupak@gmail.com)
 * @version 1.0
 */
@Named
public class ChromPosReferenceBasesAlternateBasesRequestConstructor implements RequestConstructor, Serializable {
    ...
    public String getUrl(String template, String beacon, String ref, String chrom, Long pos, String referenceAllele, String allele, String dataset) {
        return String.format(template, chrom, pos, referenceAllele, allele);
    }
